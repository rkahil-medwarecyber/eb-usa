...
data "aws_ssm_parameter" "cloudflare_api_token" {
  name            = var.cloudflare_api_token_path
...
resource "cloudflare_dns_record" "sftp_cname" {
  zone_id = data.cloudflare_zone.medwarecyber_zone.id

  name    = var.eb_sftp_dns_name
  type    = "CNAME"
  content = aws_transfer_server.eb_sftp.endpoint
